...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference("UserDetail.count") do
      post user_details_url, params: { user_detail: { dob: @user_detail.dob, firstname: @user_detail.firstname, lastname: @user_detail.lastname, level: @user_detail.level, phone: @user_detail.phone, user_id: @user_detail.user_id } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { dob: @user_detail.dob, firstname: @user_detail.firstname, lastname: @user_detail.lastname, level: @user_detail.level, phone: @user_detail.phone, user_id: @user_detail.user_id } }
