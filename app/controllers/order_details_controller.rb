class OrderDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order_detail.save
        format.html { redirect_to order_path(@order_detail.order_id), notice: "Order detail was added." }
  ...
  def update
    respond_to do |format|
      if @order_detail.update(order_detail_params)
        format.html { redirect_to order_path(@order_detail.order_id), notice: "Order detail was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to order_path(@order_detail.order_id), notice: "Order detail was successfully destroyed." }
